      ...
      <div className="film-list">
        ...
        {!fav && (
          <>
            ...
            >
              <option value="">Select release year (default 2022)</option>
              {years.map((year) => (
        ...
        <div className="film-list-filters">
          <button
            className={`film-list-filter ${!fav && "is-active"}`}
          ...
          <button
            className={`film-list-filter ${fav && "is-active"}`}
            onClick={selectFavTab}
          >
            FAVES
            <span className="section-count">
              {" "}
              {films.filter((item) => item.fav === true).length}
            </span>
          </button>
        </div>
        {fav === false
